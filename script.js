...
const timelinesData = [
  ...
  {
    page: "page7",
    selector: "page7 #inner7-text",
  },
  {
    page: "page8",
    selector: "page8 #inner8-text",
  },
  {
    page: "page9",
    selector: "page9 #inner9-text",
  },
  {
    page: "page10",
    selector: "page10 #inner10-text",
  },
];

const timelines = {};

timelinesData.forEach(({ page, selector }) => {
  timelines[page] = gsap.timeline({
    scrollTrigger: {
      trigger: `#${page}`,
      start: "top top",
      scroller: "#main",
...
function canvas1(){
  ...
  function files(index) {
  var data = `./Apple vision canvas images/Vision00001.png
...
tlImg.to("#page17 #troff", {
  opacity:0,
})


var tlSnr =gsap.timeline({
  scrollTrigger: {
    trigger: `#page18`,
    start:`top top`,
    scroller:`#main`,
